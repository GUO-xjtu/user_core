...
require (
	code.byted.org/kite/kitex v1.10.3
...
require (
	...
	code.byted.org/gopkg/logs/v2 v2.1.23 // indirect
	code.byted.org/gopkg/metainfo v0.1.1 // indirect
	code.byted.org/gopkg/metrics v1.4.14 // indirect
	code.byted.org/gopkg/metrics/v3 v3.1.22 // indirect
	...
	github.com/cloudwego/kitex v0.4.3 // indirect
